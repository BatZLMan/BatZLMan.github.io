...
<p>
If I could go back in time and do things differently, I would review the recorded lectures on Laulima at least twice while assignment two was open on Laulima. I also could have done assignment two little by little each day to combat the hectic schedule during the past few weeks. Nonetheless, I will apply the lessons that I learned from doing assignment two to improve the quality of the upcoming assignment three.
</p>
<br>
